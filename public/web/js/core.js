...
define(['jquery', 'core'], function($, core) {
    ...
    core.loading = function() {
        ...
        if ($('#core_loading').length <= 0) {
            $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-35px;margin-top:-30px;position:absolute;width:80px;height:80px; z-index:999999"><img src="/web/images/loading.gif" width="80" /></div>')
        } else {
            $('#core_loading').show();
        }
    }
