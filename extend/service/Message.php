...
class Message {
     ...
     * @param Array $data ['code' => 123456]
     * @return stdClass
     */
    private static function sendSms($MobilePhone, $template_code, Array $data) {
     ...
     * @return stdClass
     */
    private static function sendBatchSms() {
     ...
     * @return stdClass
     */
    private static function querySendDetails() {
        ...
        // 必填，短信接收号码
        $request->setPhoneNumber("13640734742");
        
        // 必填，短信发送日期，格式Ymd，支持近30天记录查询
        $request->setSendDate("20190125");
    ...
    public function send(Request $request){
        ...
        $response = self::sendSms($mobile, 'SMS_157645186', ['code' => $checkcode]);
    ...
    public function queryMsgDetails(){
        $response = self::querySendDetails();
    ...
    public function check(Request $request){
        ...
        if (session($mobile.'_forgetcode') == $code){
